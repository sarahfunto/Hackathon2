...
2. Applies a domain rule layer to override some obviously high-risk cases (e.g. multiple early-onset breast/ovarian cancers, BRCA mutations).
...
├── notebooks/
│   └── HAckathon_~2_dataset_fictif.ipynb   # Training & exploration notebook
├── src/
